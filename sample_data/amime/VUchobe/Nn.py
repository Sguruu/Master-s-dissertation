...
interes["year"] = interes["Дата рождения"].dt.year  # Создаем колонку Год из поля Дата
...
# Теперь ставим задачу классификации, и будем определять по параметрам следующие значения
...
#y.to_excel("2 Данные вероятность.xlsx")
...
print("Рекомендую ", model.predict(exemple))
